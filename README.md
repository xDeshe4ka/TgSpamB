...
<h2>Русский</h2>
<h4>Этот скрипт создан для массовой рассылки (спама) в телеграм с нескольких аккаунтов, разработан 
(tihiydo) позже доработан xDeshe4ka а именно 20.02.2026, используйте его с умом и пришлите мне пару долларов на кофе.<h4>
...
3. Отредактируйте файл TGAccounts.txt, добавляя номер телефона вашей учетной записи в каждой новой строке.<br>
4. Отредактируйте файл targets.txt, добавляя туда ID/Username учетной записи человека в каждой новой строке.<br>
5. После этого вы должны запустить команду <code>pip install -r requirements.txt</code> внутри папки, в которую вы распаковали этот скрипт.<br>
6. Чтобы запустить скрипт, напишите команду <code>python start.py</code> или <code>python3 start.py</code> внутри папки, в которую вы распаковали скрипт.<br>
 7. ВАЖНО, ОБНОВИТЕ ФАЙЛ .env НА ВАШИ ДАННЫЕ, ЧТОБЫ У ВАС СРАБОТАЛ СКРИПТ.<br> 
<br>
<b>Режимы работы:</b><br>
- <b>Режим 1:</b> Парсинг участников из выбранного чата и рассылка им<br>
- <b>Режим 2:</b> Рассылка по списку из файла <code>targets.txt</code> (username или ID пользователей, каждый с новой строки)
</em><br><br>
...
<h2>English</h2>
<h4>This script was created for mass sending (spam) to telegrams from several accounts, it was developed by (tihiydo) later xDeshe4ka was finalized, namely 02/20/2026 , use it wisely and send me a couple of dollars for coffee.<h4>
<h3>Installing:<h3>
